...
3. The PCB struct contains an ID to locate it's position in RAM.
4. exec and run will print out the commands as they are processed. So for example, if you call exec testfile.txt that contains the set x 1 command, set x 1 will be printed in the terminal.
